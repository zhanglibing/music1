...
//list按钮点击 列表页出现  再次点击消失
    ...
    $(".time-right .move").on("mouseup", function () {
...
////////////////////////////每首歌播放结束后/////////////////////////////////////
    $(audio).on("ended", function () {
        ...
        $(".top").append("<div class=title>" + database[index].songs + "</div><div class=people>" + database[index].name + "</div><div class=lyric-box><div class=lyric></div></div>")
        $(database[index].lyrics).each(function (i, v) {
            $("<p class=" + i + ">" + v.lyric + "</p>").appendTo(".top .lyric")
        })
        audio.play()
